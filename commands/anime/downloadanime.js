...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    Anime.fromName(cmd[0])
        ...
        anime.episodes[cmd[1] - 1].fetch().then(function(episode) {
          ...
          if (episode.videoLinks[1].url) {
            embed.addField(
              ...
              `[Link](https:${episode.videoLinks[1].url})`,
              true
            );
          }
      ...
      .catch(err => {
        msg.delete();
        client.x.embed.wrong(
          "I am unable to scrap the links of episode",
          message
        );
      });
  }
